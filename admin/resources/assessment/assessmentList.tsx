...
const AssessmentList = () => {
    return (
        <ListDataGridWithPermissions>
            ...
            <ReferenceField source="deadline_id" reference="deadline" label="District">
            ...
            <ReferenceField source="submission_type_v2_id" reference="submission_type" label="Aggregation">
                <TextField  source="aggregation"/>
            </ReferenceField>
            <ReferenceField source="submission_type_v2_id" reference="submission_type" label="Category">
