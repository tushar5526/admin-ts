import {
    ...
    NumberField,
    ReferenceField,
    TextField, useRecordContext, useDataProvider, useResourceContext, LinearProgress,
} from "react-admin";
...
const MappingList = () => {
    const Filters = [
        ...
        <ReferenceInput key={'school_id'} label="School" source="school_id" reference="school">
            <SelectInput label="School" optionText="name"/>
        </ReferenceInput>,
        <ReferenceInput key={'udise'} label="Udise" source="school_id" reference="school">
        ...
        >
          <TextField source="month3" />
                ...
                <ReferenceField label="District" source="school_id" reference="school">
                    <ReferenceField label="District" source="location_id" reference="location">
                ...
                <ReferenceField label="Cluster" source="school_id" reference="school">
                    <ReferenceField label="Cluster" source="location_id" reference="location">
